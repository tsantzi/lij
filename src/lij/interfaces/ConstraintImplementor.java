...
/**
 * This interface is used to denote user-provided classes that can be used to
 * provide implementations of constraint methods.
 * 
 * @author Nikolaos Chatzinikolaou
 */
public interface ConstraintImplementor
{
}
